const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "/shops/:id",
        name: "shop_detail",
        component: () => import("@/view/pages/shop/store-detail.vue"),
        meta: { requiresAuth: true }
      },
      {
        path: "/shops/:id/edit",
        name: "shop_edit",
        component: () => import("@/view/pages/shop/store-edit/store-edit.vue"),
        meta: { requiresAuth: true }
      },
      {
        path: "/shops/create",
        name: "store_create",
        component: () => import("@/view/pages/shop/store-create/store-create"),
        meta: { requiresAuth: true }
      },
      {
        path: "/shops/test",
        name: "store_test",
        component: () => import("@/view/pages/shop/store-test"),
        meta: { requiresAuth: true }
      },
      {
        path: "/users/:id",
